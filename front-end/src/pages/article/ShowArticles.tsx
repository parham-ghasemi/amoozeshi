...
const fetchMostViewed = () => axios.get("/api/articles/most-viewed").then(res => res.data);
const fetchNewest = () => axios.get("/api/articles/newest").then(res => res.data);
const fetchCategories = () => axios.get("/api/categories").then(res => res.data.categories);
const fetchArticlesByCategory = (id: string) => axios.get(`/api/articles/category/${id}`).then(res => res.data);
const fetchAllArticles = () => axios.get("/api/articles").then(res => res.data);
