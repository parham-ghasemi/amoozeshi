...
const CourseShowcase = () => {
  ...
  return (
    <div className="w-full max-w-[90%] lg:max-w-6xl mx-auto p-4 sm:p-6 space-y-6 flex items-center flex-col min-h-screen">
      ...
      <div className="w-full flex gap-5">
        ...
        <div className="flex flex-col gap-5 w-fit">
          <div className="bg-white shadow-xl w-96 h-fit rounded-lg p-5 flex flex-col gap-7">
            <div className="w-full bg-blue-300 rounded-lg px-7 py-4 flex items-center gap-5 justify-end">
              ...
              <svg width="22" height="30" viewBox="0 0 22 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M5.87382 7.89688L1.01958 5.6664C1.01352 5.66206 1.00859 5.65633 1.00518 5.64969C1.00178 5.64306 1 5.63571 1 5.62825C1 5.62079 1.00178 5.61344 1.00518 5.60681C1.00859 5.60017 1.01352 5.59444 1.01958 5.5901L10.6341 1H10.6694L20.2546 5.54314C20.2606 5.54679 20.2657 5.55195 20.2692 5.55813C20.2726 5.5643 20.2745 5.57127 20.2745 5.57836C20.2745 5.58545 20.2726 5.59242 20.2692 5.59859C20.2657 5.60476 20.2606 5.60992 20.2546 5.61358L15.4355 7.89688" stroke="black" />
            ...
            <p className="flex justify-end gap-3">
              <span>
                {levelMap[course.level.toLowerCase() as keyof typeof levelMap]}
              </span>
              :سطح دوره
            ...
            <p className="flex justify-end gap-3">
              <span className="flex flex-col items-end gap-2.5">
                ...
                <span className="text-end mr-9 text-pretty text-sm leading-7">
                  {course.goal}
                </span>
          ...
          <div className="w-full min-h-4 bg-white shadow-xl rounded-lg p-5 flex flex-col items-center gap-7">
            ...
            <p className="p-3 border hover:border-neutral-400 transition-all cursor-pointer rounded-2xl text-xs font-light" onClick={() => navigator.clipboard.writeText(window.location.href)}>
        ...
        <div className="w-full flex flex-col gap-5">
          ...
          <div className="w-full bg-white shadow-xl rounded-xl p-5 flex flex-col gap-3 items-end">
            <h3 className="font-bold text-sm">:توضیحات کوتاه</h3>
            <p className="text-end text-pretty text-sm">
              {course.shortDesc}
            </p>
          </div>
          <div className="min-h-[200px] sm:min-h-[300px] bg-white shadow-xl p-4 sm:p-6  rounded-xl w-full flex flex-col gap-7" dir="rtl">
            {renderEditorContent(course.longDesc)}

            <div className="py-5 px-14 border border-gray-500 rounded-xl flex flex-col items-center gap-5">
              <h3 className="font-black text-lg">سرفصل های دوره</h3>
              {
                course.topics.map((topic, index) => (
                  <div className="w-full flex flex-col" key={`${topic.head}-index-${index}`}>
                    <p onClick={() => handleTopicClick(index)}
                      className={clsx("border border-gray-400 hover:border-gray-600 transition-all rounded w-full py-2.5 px-5 cursor-pointer flex gap-2.5",
                    ...
                    <p className={clsx(
                      'text-sm font-light border-b border-l border-r p-2.5 rounded border-gray-600 rounded-t-none transition-all duration-700 ease-in-out',
            ...
            </div>
            {
              course.questions.map((question, index) => (
                <div className="" key={`${question.question}-index-${index}`}>
                  ...
                  <p className="text-sm font-light border-b pb-3">{question.answer}</p>
                </div>
              ))
            }
          </div>
      ...
      {course.related && course.related.length > 0 && (
        <div className="min-h-[200px] sm:min-h-[300px] bg-white shadow-xl py-6 sm:py-10 px-4 sm:px-10  rounded-xl w-full flex flex-col" dir="rtl">
          <h1 className="text-lg sm:text-xl font-bold mb-6 sm:mb-10">دوره‌های مشابه</h1>
