...
const CounselSearchBox = ({ initSearchTerm }: { initSearchTerm?: string }) => {
  ...
  const handleSearch = async (e: FormEvent) => {
    ...
    if (searchTerm.trim()) {
      ...
      navigate(`/counsels/results?search_query=${encodedQuery}`);
    } else {
      setSearchError(true);
    }
  };
...
export default CounselSearchBox;